        ...
        <draggable :list="list" :animation="100" item-key="index" :forceFallback="true" handle=".move">
            <template #item="{ element, index }">
                <div class="flex-row-center">
                    <div class="flex-row-center flex-auto">
                        <div class="group-item mr10">col{{ element.span }}</div>
                        <el-slider v-model="element.span" :min="1" :max="24" />
                    </div>
...
import { addColItem } from "../../layout/row/index";
